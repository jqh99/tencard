...
@section('container')
    <div class="container">
        ...
        <form id="loginForm" method="POST" action="/auth/login" onsubmit="fanzhuan();">
            {!! csrf_field() !!}
        ...
        <div class="login-center clearfix">
            ...
            <div class="login-center-input">
                <input type="password" name="password" required="required" value="" placeholder="请输入您的密码" onfocus="this.placeholder=''" onblur="this.placeholder='请输入您的密码'"/>
